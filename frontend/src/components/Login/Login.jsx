      ...
      <header className="border-b border-[#e2e8f0] bg-white">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-2 text-sm">
            ...
            <Link to="/login" className="px-3 py-1.5 rounded-full border border-[#0f172a] bg-[#0f172a] text-white">
              Login
            </Link>
      ...
      <div className="min-h-[calc(100vh-72px)] flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md rounded-2xl border border-[#e2e8f0] bg-white shadow-sm p-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f8fafc] border border-[#e2e8f0]">
              ...
              <span className="text-xs text-[#64748b] font-semibold tracking-wide">Welcome back</span>
            </div>

            <h2 className="mt-4 text-3xl font-extrabold text-[#0f172a]">Login</h2>
            <p className="mt-2 text-sm text-[#64748b]">Sign in to continue shopping.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-center text-sm text-[#64748b]">
            ...
            <Link to="/sign-up" className="ml-1 text-[#0ea5e9] font-semibold hover:underline">
              Sign Up
            </Link>
          </div>
        </form>
